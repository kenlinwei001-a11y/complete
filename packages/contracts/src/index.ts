...
export * from "./approval-policy.js"; // WO-APPROVAL-POLICY · 批复策略引擎：批复链由「业务规则(ApprovalPolicy.condition·复用 A5 规则 DSL) × 组织权限(ApprovalAuthority)」动态生成，与业务流程正交（ProcessDefinition 零改动）；多策略命中走并集按层级合并（§5）
