...
export const OPERATION_CATALOG: OperationCatalogEntry[] = [
  ...
  { op: "model", label: "半自动建模·数据→本体草稿→发布", keywords: ["建模", "model", "建模型", "类型", "schema"], endpoint: "/a/v1/modeling/derive", requiredSlots: ["datasetIds"], r4: true, cliCommand: "model" },
  ...
  { op: "rule", label: "规则库·建/dry-run/发布", keywords: ["规则", "约束", "rule", "底线"], endpoint: "/a/v1/rules", requiredSlots: ["expression"], r4: true, cliCommand: "rule" },
  ...
  { op: "agent", label: "Agent/智能体 配置", keywords: ["agent", "智能体"], endpoint: "/b/v1/agents", requiredSlots: [], r4: false, cliCommand: "agent" },
