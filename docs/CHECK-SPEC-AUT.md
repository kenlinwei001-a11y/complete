...
## 1 · `SPEC-industrial-skill.md` 逐条（196 条）
...
## 2 · `PRD-addendum-skill-authoring.md` 逐条（78 条）
...
而最该先看的不是这 88 条，是 **14 条「宣称做了其实没做」（F1–F14）**：其中 **F8/F9/F10 三条是「已经做完了但文档还写着没做」**
