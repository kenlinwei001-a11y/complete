...
| 订单全链 `order-chain` | **符合** | 不符合 | **不符合** | **符合** | 不符合 | **符合** | **符合** | **符合** | **符合** | **不符合** |
...
| 归因 `cleanroom-attr` | **符合** | 不符合 | **不符合** | **不适用** | 不适用 | **符合** | **不符合** | **符合** | **不符合** | **符合** |
| 影响半径 `disruption-radius` | **符合** | 不符合 | **不符合** | **符合** | 不符合 | **符合** | **不符合** | **符合** | **不符合** | **符合** |
| 方案生成 `plan-generate` | **符合** | 不符合 | **不符合** | **符合** | 不适用 | **符合** | **符合** | **符合** | **符合** | **不符合** |
| 月度规划 `sop-balance` | **不符合** | **不符合** | **不符合** | **符合** | 不适用 | **符合** | **符合** | **符合** | **符合** | **不符合** |

**合计（12 页 × 10 判据 = 120 格）：符合 62 · 不符合 50 · 判不了 0 · 不适用 8。**
（上一版：符合 60 · 不符合 53 · 判不了 0 · 不适用 7。再上一版：符合 17 · 不符合 46 · 判不了 57 · 不适用 0。）
...
关掉的边留在列表里可拨回），并另加一条本页特有的：**「已关 N 条 · 下方为反事实读数」徽标留在第一层**
