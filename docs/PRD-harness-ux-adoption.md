...
| 全局项目推演 `global-sim` | **符合** | 不符合 | **不符合** | **符合** | **不符合** | **符合** | **符合** | **符合** | **不符合** | **不符合** |
| 产能推演 `risk` | **符合** | 不符合 | **不符合** | **符合** | 不符合 | **符合** | **符合** | **符合** | **符合** | **不符合** |
<<<<<<< ours
| 订单全链 `order-chain` | **符合** | 不符合 | **符合** | **符合** | 不符合 | **符合** | **符合** | **符合** | **符合** | **不符合** |
| 决策推演 `decision-play` | **符合** | **不符合** | **不符合** | **符合** | **不符合** | **符合** | **符合** | **不符合** | **符合** | **不符合** |
...
| 方案生成 `plan-generate` | **符合** | 不符合 | **不符合** | **符合** | **不符合** | **符合** | **符合** | **符合** | **符合** | **不符合** |
| 月度规划 `sop-balance` | **不符合** | **不符合** | **不符合** | **符合** | **不符合** | **符合** | **符合** | **符合** | **符合** | **不符合** |
