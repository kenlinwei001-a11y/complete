...
| ~~2~~ | ✅**WO-SCENE-A** | 闭 | 规划体检对话入口 `WORKFLOW_ONLY`→`WORKFLOW_FIRST`（1 行解拒答） | [`docs/WO-design-landing-items-1-2-3.md`](https://github.com/kenlinwei001-a11y/complete/blob/claude/vigilant-knuth-b1nmxn/docs/WO-design-landing-items-1-2-3.md) |
| ~~3~~ | ✅**WO-SHARE17** | 闭 | 方案份额/收入魔数(-17/-100)→求解器下发 shareDelta/revGrowthPct（消自相矛盾） | [`docs/WO-design-landing-items-1-2-3.md`](https://github.com/kenlinwei001-a11y/complete/blob/claude/vigilant-knuth-b1nmxn/docs/WO-design-landing-items-1-2-3.md) |
| ~~4~~ | ✅**WO-CSS** | 闭 | DAG 深字 typo `--text`→`--txt` + `css-vars:check` 门 + 全站对比度审计 | [`docs/WO-design-landing-items-1-2-3.md`](https://github.com/kenlinwei001-a11y/complete/blob/claude/vigilant-knuth-b1nmxn/docs/WO-design-landing-items-1-2-3.md) |
...
| 21 | **WO-ALERT** | **P1** | 主动决策推送：扩 RuleScanService 覆盖关键决策规则→告警→联 mitigation_select 出处置建议→push 待办（替纯 PULL·D6） | [`PRD-decision-support-maturity.md` §3.7 D6](https://github.com/kenlinwei001-a11y/complete/blob/claude/vigilant-knuth-b1nmxn/docs/PRD-decision-support-maturity.md) |
| 22 | **WO-ACTUATE** | **P1·后置真连接器** | 决策出站执行：连接器加 writeBack 适配器→approved Action push 回 ERP/MES→writeback-echoes 防回环对账（替"停在建议层"·D7） | [`PRD-decision-support-maturity.md` §3.7 D7](https://github.com/kenlinwei001-a11y/complete/blob/claude/vigilant-knuth-b1nmxn/docs/PRD-decision-support-maturity.md) |
| 23 | **WO-DECISION-RECORD** | P2 | 一等 Decision 记录：上下文/备选方案/否决理由/决策人/预测 vs 实现 outcome（问责+组织学习·D8） | [`PRD-decision-support-maturity.md` §3.7 D8](https://github.com/kenlinwei001-a11y/complete/blob/claude/vigilant-knuth-b1nmxn/docs/PRD-decision-support-maturity.md) |
| 24 | **WO-OBSERVABILITY** | P2 | 平台运维可观测：dc_* metrics/锁/抽取指标→平台健康 SLO 看板+告警（非业务·D8） | [`PRD-decision-support-maturity.md` §3.7 D8](https://github.com/kenlinwei001-a11y/complete/blob/claude/vigilant-knuth-b1nmxn/docs/PRD-decision-support-maturity.md) |
