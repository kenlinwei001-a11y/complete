...
| **迁移** | `apps/datacore/migrations/032_org_world.sql`（4 表 + 索引建在**机器键**上，含 down） |
...
`apps/datacore/migrations/032_org_world.sql` · `apps/datacore/test/org-world.test.ts` · 本文档。
