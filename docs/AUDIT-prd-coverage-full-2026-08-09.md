...
> |---|---|---|---|
> | CF-1 | 覆盖 `docs/` 下**全部 147 份** PRD 类文档；`ls docs/*.md` = **237** 份 | `ls docs/*.md` = **294**（+57）；`ls docs/PRD-*.md` = **133**，`docs/industrial-prd/PRD-*.md` = **12**（合 145，与 147 差 2，口径未对齐） | ⚠️ 规模数字已过期·**「100% 覆盖」这个自称对今天不成立** |
