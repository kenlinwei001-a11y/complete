...
> - [ ] **dash**（最大缺口：约 6 卡 vs 八卡+台账+3DAG；9 区块；4→8 根因）。命名已裁（K7 枣庄线 ✅命名就绪）；八卡/台账/3DAG/8 根因主体待建（依赖基地集重播完成 K4 江门）。无依赖块（8 根因 ROOT_LIB/PROB_META、order_margin_contrib Σ勾稽、问题面板/3DAG）可独立推进。
