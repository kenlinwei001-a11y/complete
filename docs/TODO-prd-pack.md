...
> - 余 DF.4（审计阈值/ORDER 等剩余硬编码迁 boundary，**注：calibration-coupled，须同回归 audit/sop/quarter**）· DF.10 boundary 版本化 · DF.11 A5 自动抽 · DF.12 绑定面板 · DF.13b BP-7 · DF.13c 前端文件↔表可见 · DF.14–16（需求可溯/A-B 归一）。
