...
try {
  ...
  await page.screenshot({ path: "docs/evidence/S5-sandbox-tick-calendar-realbrowser.png", fullPage: false });
  ok("截图 docs/evidence/S5-sandbox-tick-calendar-realbrowser.png");
} catch (e) {
