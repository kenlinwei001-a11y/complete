...
function main() {
  ...
  if (!selftestOnly) {
    ...
    // ⑥b 扫描规模下限：记号在生产源码里**今天真有实例**（@stale-self marks.production ==13
 ...
 *        赌注：@stale-self marks.production ==13
 ...
 *      2026-08-17 WO-SCREEN-PLAINSPEAK 给 `processWait.honesty.cannotAnswer` 补了一条
 *      「9 条反推得出」的赌注，12 → 13，@stale-self marks.production ==13）、
