...
export const EVENT_SUBSCRIPTIONS: EventSubscription[] = [
  ...
  // WO-A · Plan Builder Canvas 发布 → 画布列表/场景/意图绑定失效。
  { event: "plan.canvas.published", producer: "Plan Builder 画布发布", tier: "IN_SESSION", invalidates: ["plan-builder", "scenarios", "intent-editor.workflow-bindings"] },
  // L5 行动环 / DL4
