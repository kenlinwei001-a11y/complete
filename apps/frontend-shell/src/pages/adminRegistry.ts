...
export const ADMIN_PAGES: AdminPageDef[] = [
  ...
  { path: "build-pipelines", label: zh.nav.buildPipelines, roles: ["admin"] },
...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  { key: "build", title: "构建与成长", paths: ["data-builder", "build-pipelines", "growth", "evals", "solvers", "solver-review"] },
