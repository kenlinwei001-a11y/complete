...
function PlanEditor({ plan, packageId }: { plan: ExecutionPlan | null; packageId: string }) {
  ...
  if (!plan) {
    return (
      <div className="muted" style={{ fontSize: 11.5, marginTop: 6 }} data-testid="plan-editor-unbound">
  ...
  return (
    <div className="panel" style={{ marginTop: 8, padding: 8 }} data-testid="plan-editor" data-plan-status={plan.status}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        <span className="mono" style={{ fontSize: 11 }} data-testid="plan-editor-key">{plan.key} v{plan.version}</span>
      ...
      <textarea
        ...
        style={{ width: "100%", minHeight: 120, marginTop: 6, fontFamily: "var(--font-mono)", fontSize: 11 }}
      />
      {parseError && (
      ...
      {impact && (
        <div style={{ marginTop: 6, fontSize: 11.5 }} data-testid="plan-publish-impact">
