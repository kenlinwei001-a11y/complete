...
export const zh = {
  ...
  risk: {
    ...
    planEff: "预期",
    planRule: "规则",
    regeneratePlan: "⚙ 生成/重算行动计划",
    affectedOrders: "受影响订单",
    dailyStrip: "逐日张力",
    // WO-LIVE-DISPOSITION：行动项逐日推演明细
    dispositionDetail: {
      title: "行动推演明细",
      stepAction: "动作",
      stepRationale: "触发依据",
      stepTrigger: "触发指标",
      stepClosesGap: "收窄缺口",
      stepProvenance: "来源与推导",
      stepProvenanceNote: "WO-LIVE-DISPOSITION：逐日处置步骤由 risk_timeline 求解器按触发值+收窄量确定性派生",
    },
