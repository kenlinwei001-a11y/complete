  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }} data-testid="optimize-whatif">
      ...
      <div className="panel">
        ...
        <div style={{ fontSize: 11, color: "var(--muted2)", marginTop: 6 }} data-testid="ow-family-source" data-authoritative={authoritative ? "1" : "0"}>
          {authoritative
      ...
      <div className="panel" data-testid="ow-retrieve">
        <div className="section-title">按需求找模板<span style={{ fontSize: 11, color: "var(--muted2)", fontWeight: 400, marginLeft: 8 }}>只帮你选型，不参与求解</span></div>
        ...
        {retrieveQuery.isError && (
          <div style={{ fontSize: 11.5, color: "var(--amber)", marginTop: 6 }} data-testid="ow-retrieve-error">
        ...
        {retrieveQuery.data && (
          <div style={{ marginTop: 8, fontSize: 12 }} data-testid="ow-retrieve-result" data-mode={retrieveQuery.data.mode}>
            ...
            {retrieveQuery.data.note && (
              <div style={{ fontSize: 11, color: "var(--muted2)", marginTop: 4 }} data-testid="ow-retrieve-note">{retrieveQuery.data.note}</div>
            )}
          </div>
        )}
      </div>
