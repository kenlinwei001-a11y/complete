...
export class SyntheticService {
  ...
  private async instantiateBattery(
    ...
    await putAll("WinLossRecord", ext.winLossRecords, "oppId");
    await putAll("PriceRealization", ext.priceRealizations, "realizationId");
    await putAll("ARAging", ext.arAgings, "agingId");
    await putAll("DSO", ext.dsoRecords, "dsoId");
