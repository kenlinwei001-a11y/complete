...
export const BATTERY_SOLVER_PARAMS: Record<string, unknown> = {
  ...
  maintMult: 0.72,
  // G-10 P4 单源：staleHours/degraded = C09 的命名阈值；normal **不**归规则（M11 校准参数 p90_health 的 path）。
  health: { normal: 0.93, degraded: ruleParamOf("C09", "degradedFactor"), staleHours: ruleParamOf("C09", "staleHours") },
