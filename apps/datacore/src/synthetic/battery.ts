 ...
 *
 * ## `weight` = 订单分配权重（**故意不平均**）
 * 平均分给 20 家 ⇒「客户集中度」这个分析恒等于 5%×20，等于把分析做死。
 * 本表按真实供应商客户结构给长尾权重（少数大客户吃掉大半，尾部一堆小客户）。
 * 权重和 = 1000，仅作相对比例用；实际落数还要叠加 24 张锚点单的既有客户，故实测占比与名义略有出入。
 *
 * ⚠ 前 8 家（`广汽集团`…`国家电投`）是 24 张锚点订单上写着的客户，**一个字都不许改**。
 */
export const CUSTOMER_REGISTRY: { name: string; businessType: BusinessType; weight: number }[] = [
  // ── 锚点 8 家（24 张手写订单上的客户·全仓测试与文档的坐标·禁止改名）──
  { name: "广汽集团", businessType: "passenger", weight: 180 },
  { name: "国家电网", businessType: "storage", weight: 130 },
  { name: "长安汽车", businessType: "passenger", weight: 110 },
  { name: "南方电网", businessType: "storage", weight: 85 },
  { name: "东风汽车", businessType: "passenger", weight: 75 },
  { name: "吉利汽车", businessType: "passenger", weight: 60 },
  { name: "宇通客车", businessType: "commercial", weight: 55 },
  { name: "国家电投", businessType: "storage", weight: 48 },
  // ── 原已在册、但 24 张锚点单里没出现过的 6 家（此前只在 CUSTOMERS 池里，主数据侧被并进匿名代号）──
  { name: "小鹏汽车", businessType: "passenger", weight: 38 },
  { name: "金龙客车", businessType: "commercial", weight: 33 },
  { name: "奇瑞", businessType: "commercial", weight: 26 },
  { name: "龙源电力", businessType: "storage", weight: 22 },
  { name: "瑞驰新能源", businessType: "commercial", weight: 12 },
  { name: "Ashok Leyland", businessType: "commercial", weight: 4 },
  // ── 本单新增 6 家（凑满 20 家·沿用既有「真实整车厂 / 客车厂 / 发电集团」命名风格）──
  { name: "上汽集团", businessType: "passenger", weight: 42 },
  { name: "华能集团", businessType: "storage", weight: 29 },
  { name: "北汽蓝谷", businessType: "passenger", weight: 18 },
  { name: "中通客车", businessType: "commercial", weight: 15 },
  { name: "一汽红旗", businessType: "passenger", weight: 10 },
  { name: "福田汽车", businessType: "commercial", weight: 8 },
];
