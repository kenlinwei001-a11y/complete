...
export function batteryDataCategories(): DataCategory[] {
  ...
  return [
    {
      key: "sales_orders", displayName: "销售订单", description: "客户下达的电池销售订单（型号/数量/交期/状态）及订单承诺台账（ATP/CTP·能不能接/何时交）。",
      typeKeys: ["Order", "OrderPromise"], modes: [...BOTH], defaultMode: "SYSTEM_INTEGRATION", connectorTypeKeys: ["sap_erp", "salesforce_crm", "rest_api", "file_upload"],
    },
    {
