 ...
 *
 * WO-SIM-ROOT-TRIAD：在上一轮 35 条之上再补 **4 条**根源边（G-ROOT-1 预测偏差 1 条 /
 * G-ROOT-2 订单变更 2 条 / G-ROOT-4 设备故障 1 条），共 **39 条**。传导图的**根源**
 * （入度 0）由 **3 → 5**，且 `demandPressure` 由根源**降级为一级衍生**（入度 0 → 1）——
 * 详见数组尾部 `WO-SIM-ROOT-TRIAD` 段头。
 *
