 ...
 *
 * 逐条核过 C01–C34（本仓实播 29 条：C01–C06 / C08–C13 / C15 / C16 / C18 / C21–C34；C07/C14/C17/C19/C20
 * **压根不存在**。C34 跨业务线产能争用由 WO-A6-CONTENTION 补入，同样不带金额/费率）
 * ——没有任何一条承载"交付延误 → 赔多少"：
 ...
 * 场景包 `BATTERY_RULES` 29 条里没有它（实播规则：C01–C06/C08–C13/C15/C16/C18/C21–C34）。
