...
export const SOLVER_CATALOG: CatalogItem[] = [
  ...
  { key: "capex_scenario", name: "年度情景测算", description: "三情景产能投资测算（供给曲线/缺口窗口/项目级 IRR/util24/C23 判定）。", argHints: { scenario: "情景 key" }, domain: "plan", answersQuestions: ["三情景产能投资怎么测算", "项目 IRR 和缺口窗口是多少", "各情景供给曲线怎么走"], tags: ["情景投资", "capex", "irr"] },
