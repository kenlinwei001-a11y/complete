...
async function seedOccupancyOntology(t: Awaited<ReturnType<typeof makeApp>>, withContract: boolean) {
  await t.repos.ontologyTypes.put({ id: "ot_ord", tenantId: "co", key: "SalesOrder", displayName: "销售订单", domain: "x", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "soId", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }, { propKey: "rev", dataType: "number", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }, { propKey: "pen", dataType: "number", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }, { propKey: "q", dataType: "number", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }, { propKey: "ctr", dataType: "string", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }] });
  await t.repos.ontologyTypes.put({ id: "ot_line", tenantId: "co", key: "ProdLine", displayName: "产线", domain: "x", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "lineId", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }, { propKey: "cap", dataType: "number", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }] });
  ...
  if (withContract) {
    await t.repos.ontologyTypes.put({ id: "ot_ctr", tenantId: "co", key: "SupplyContract", displayName: "供货合同", domain: "x", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "ctrId", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }, { propKey: "quota", dataType: "number", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }] });
