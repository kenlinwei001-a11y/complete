...
async function seed(t: TestApp) {
  ...
  await t.repos.ontologyTypes.put({ id: "ot_b", tenantId: "demo", key: "Base", displayName: "基地", domain: "factory", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "baseId", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }, { propKey: "capacity", dataType: "number", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }] });
