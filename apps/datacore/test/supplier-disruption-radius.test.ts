...
describe("PRD-fde §8 Q2 · supplier_disruption_radius 求解器（断供影响半径反向扇出）", () => {
  ...
  async function seedSupplyChain(t: TestApp, ctx: AuthCtx) {
    await t.repos.ontologyTypes.put({ id: "ot_sup", tenantId: ctx.tenantId, key: "Supplier", displayName: "供应商", domain: "supply", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "supId", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }] });
    await t.repos.ontologyTypes.put({ id: "ot_mat", tenantId: ctx.tenantId, key: "Material", displayName: "物料", domain: "supply", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "matId", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }, { propKey: "supplierRef", dataType: "ref", isPrimaryKey: false, unit: "dimensionless", scale: "absolute", refToTypeKey: "Supplier" }] });
    await t.repos.ontologyTypes.put({ id: "ot_ord", tenantId: ctx.tenantId, key: "Order", displayName: "订单", domain: "sales", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "soId", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }, { propKey: "materialRef", dataType: "ref", isPrimaryKey: false, unit: "dimensionless", scale: "absolute", refToTypeKey: "Material" }] });
    await t.repos.ontologyTypes.put({ id: "ot_cust", tenantId: ctx.tenantId, key: "Customer", displayName: "客户", domain: "sales", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "custId", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }, { propKey: "orderRef", dataType: "ref", isPrimaryKey: false, unit: "dimensionless", scale: "absolute", refToTypeKey: "Order" }] });
    // 供应商
