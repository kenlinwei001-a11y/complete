...
async function seedJobs(t: TestApp) {
  await t.repos.ontologyTypes.put({ id: "ot_j", tenantId: "demo", key: "Job", displayName: "工单", domain: "plan", version: 1, status: "ACTIVE", derivedProperties: [], sourceBindings: [], properties: [{ propKey: "jid", dataType: "string", isPrimaryKey: true, unit: "dimensionless", scale: "absolute" }, { propKey: "model", dataType: "string", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }, { propKey: "size", dataType: "number", isPrimaryKey: false, unit: "dimensionless", scale: "absolute" }] });
