...
import type { AuthCtx, ObjectTypeDef, PropertyDef, PropertyUnit } from "../src/domain.js";
...
const metricType = (opts: { actualUnit: PropertyUnit; gapFormula: string }): Omit<ObjectTypeDef, "id" | "tenantId" | "version" | "status"> => ({
  key: "Metric",
  displayName: "经营指标",
  properties: [
